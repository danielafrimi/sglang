...
class NemotronTextPipeline(ComposedPipelineBase):
    pipeline_name = "NemotronTextPipeline"

    _required_config_modules = [
        "text_encoder",
        "tokenizer",
        # "decoder",  # optional: can be mapped to text_encoder if needed
        # "vae",
        # "transformer",
        # "scheduler",
    ]
...
EntryClass = [NemotronTextPipeline]
